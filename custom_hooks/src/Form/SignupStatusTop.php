...
class SignupStatusTop extends FormBase{

	public function getFormId() {
		return 'signup_status_top_form';
	}
    ...
    $formBottom = \Drupal::formBuilder()->getForm('\Drupal\custom_hooks\Form\SignupStatus');
    $response->addCommand(new ReplaceCommand('[id^="signup-status-form"]', $formBottom));
		$response->addCommand(new ReplaceCommand('[id^="signup-status-top-form"]', $form));
